"""
Django settings for eneo project.
...
SECRET_KEY = 'django-insecure-1j835y+tftc^)jgjsti#zz^3exd6ip)y)!1p%fb%=!hf4x2fr_'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# ALLOWED_HOSTS = ['eneo-mobile.onrender.com']
